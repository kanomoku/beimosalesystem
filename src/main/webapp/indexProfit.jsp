...
<div class="box">
    ...
    <ul class="list">
        <li><span>功能:</span> <font size="4" color="#FF4500">门店维度--收益</font></li>
        <li><span>查询:</span>			
        			<form name="form" action="storeEarn" method="post">
						...
						<input type="text" name="posDay"  style="width: 30px;" /> 日，  店铺的收益<br>
...
<div class="box">
    ...
    <ul class="list">
        <li><span>功能:</span> <font size="4" color="#FF4500">业务员维度--收益</font></li>
        <li><span>查询:</span>			
        			<form name="form" action="salerEarn" method="post">
						...
						从<input type="text" name="posYear"  required="required" style="width: 30px;" /> 年
						<input type="text" name="posMonth"   style="width: 30px;" /> 月
						<input type="text" name="posDay"  style="width: 30px;" /> 日，  业务员收益<br>
						<input type="submit" value="查询" /> 
						<input type="reset" value="重置">
					</form>
		</li>
...
<div class="box">
    <div class="img">
        <img style="width:1000px;height:300px;" src="/images/31-Dingtalk_20201231191919.jpg" alt="31" />
    </div>
    <ul class="list">
        <li><span>功能:</span> <font size="4" color="#FF4500">每日--收益</font></li>
        <li><span>查询:</span>			
        			<form name="form" action="evertDayEarn" method="post">
						规格：<input type="text" name="countPerBin"  value="32" style="width: 30px;" /> 碗 /每箱<br>
						门店拿货价：<input type="text" name="storeCost"  value="4.5" style="width: 30px;" /> 元 .
						门店零售价：<input type="text" name="storeSale"  value="6.9" style="width: 30px;" /> 元 <br>
						合伙人成本：<input type="text" name="parterCost"  value="90" style="width: 30px;" /> 元 <br>
						从<input type="text" name="posYear"  required="required" style="width: 30px;" /> 年
						<input type="text" name="posMonth"   style="width: 30px;" /> 月
						<input type="text" name="posDay"  style="width: 30px;" /> 日，  每天收益<br>
						<input type="submit" value="查询" /> 
						<input type="reset" value="重置">
					</form>
		</li>
        <li><span>描述：</span><p>根据输入的项目，查询对应（年，年月，年月日）,每日收益</p></li>
    </ul>
</div>

<div class="box">
    <div class="img">
        <img style="width:1000px;height:100px;" src="/images/32-Dingtalk_20201231201508.jpg" alt="32" />
    </div>
    <ul class="list">
        <li><span>功能:</span> <font size="4" color="#FF4500">每月--收益</font></li>
        <li><span>查询:</span>			
        			<form name="form" action="evertMonthEarn" method="post">
						规格：<input type="text" name="countPerBin"  value="32" style="width: 30px;" /> 碗 /每箱<br>
						门店拿货价：<input type="text" name="storeCost"  value="4.5" style="width: 30px;" /> 元 .
						门店零售价：<input type="text" name="storeSale"  value="6.9" style="width: 30px;" /> 元 <br>
						合伙人成本：<input type="text" name="parterCost"  value="90" style="width: 30px;" /> 元 <br>
						从<input type="text" name="posYear"  required="required" style="width: 30px;" /> 年
						<input type="text" name="posMonth"   style="width: 30px;" /> 月， 每月收益<br>
						<input type="submit" value="查询" /> 
						<input type="reset" value="重置">
					</form>
		</li>
        <li><span>描述：</span><p>根据输入的项目，查询对应（年，年月）,每月收益</p></li>
    </ul>
</div>
