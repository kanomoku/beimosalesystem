...
public class PosServiceImpl implements PosService {
	...
	/*
	 * 有@Resource 可以不用写set/get public PosMapper getPosMapper() { return posMapper; }
	 * public void setPosMapper(PosMapper posMapper) { this.posMapper = posMapper; }
	 */
	...
	@Override
	public PageInfoAll showOrderPage(String posYear, String posMonth,String posDay, int pageSize, int pageNum) {

		PageInfoAll pi = new PageInfoAll();
		pi.setPageNum(pageNum);
		pi.setPageSize(pageSize);
		pi.setPosYear(posYear);
		pi.setPosMonth(posMonth);
		pi.setPosDay(posDay);
		...
		List<Pos> posList = posMapper.selOrderByPage(map);
		pi.setList(posList);
